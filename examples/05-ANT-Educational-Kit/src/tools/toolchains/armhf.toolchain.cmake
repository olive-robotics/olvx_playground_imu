...
set(LIB_DIR ${ROOT_FS}/lib/arm-linux-gnueabihf)
message(NOTICE "-- Olix LIB_DIR: ${LIB_DIR}")

set(USR_LIB_DIR ${ROOT_FS}/usr/lib/arm-linux-gnueabihf)
message(NOTICE "-- Olix USR_LIB_DIR: ${USR_LIB_DIR}")

set(USR_ARM_INCLUDE_DIR ${ROOT_FS}/usr/include/arm-linux-gnueabihf)
message(NOTICE "-- Olix USR_ARM_INCLUDE_DIR: ${USR_ARM_INCLUDE_DIR}")
...
include_directories(SYSTEM ${USR_INCLUDE_DIR} ${USR_ARM_INCLUDE_DIR} ${Olive_INCLUDE_DIR})